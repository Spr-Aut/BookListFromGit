...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public final static int NO_EXISTENCE = 0;
    //服务请求常量
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table users(" +
                ...
                ");");
        //11590,fd9a685a09cefb3c3833b6a4b1171392
        db.execSQL("insert into users(user,appkey,class_id) values ('11978'," +
                "'62cb32159c84a2e6566eebcc9893b3a5',null) ");
