package com.example.test0_debug.tools.ui;
...
public class CostumActionBar extends LinearLayout {
    ...
    public CostumActionBar(Context context) {
        super(context);
        init(context);
    }

    public CostumActionBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
